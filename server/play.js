Meteor.startup(function () {
  ...
  for(i = 0; i < 60; i++) {
    Asteroid.Collection.Dark.ReserveDeck.insert({index: i, frontImageURL: imageRoot + (randomNumbers[i] * 5 + 1700) + "/thumbnail.gif"});
    Asteroid.Collection.Light.ReserveDeck.insert({index: i, frontImageURL: imageRoot + (randomNumbers[i] * 5 + 100) + "/thumbnail.gif"});
  };
